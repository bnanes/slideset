...
public class NanoHTTPd {
    ...
    private static byte[] lh = {127,0,0,1}; //BN - see below
    ...
    public NanoHTTPd(int port) throws IOException {
        myTcpPort = port;
        myServerSocket = new ServerSocket(myTcpPort, 50, InetAddress.getByAddress(lh)); //BN - bind socket to loopback interface for security
    ...
    protected final ServerSocket myServerSocket; // Changed from 'private' to 'protected'
